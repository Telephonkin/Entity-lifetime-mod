...
public class LifetimeCounter {
	...
	public void processStart(
		...
		ServerTickEvents.END_SERVER_TICK.register(server1 -> {
			Thread entityLifetimeTimeCounter =  new Thread(()-> {
			...
			entityLifetimeTimeCounter.start();
				try {
					entityLifetimeTimeCounter.join();
